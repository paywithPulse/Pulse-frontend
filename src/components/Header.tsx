      ...
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button  onClick={() => setIsOpen(true)} className="px-6 py-2 bg-gradient-to-r from-neon-blue to-electric-teal text-text-primary font-semibold rounded-xl hover:shadow-lg hover:shadow-neon-blue/25 transition-all duration-300 transform hover:scale-105 inline-block">
              Get Started
            </button>
          ...
          <button
            onClick={() =>
              (window.location.href =
                "https://bejewelled-snickerdoodle-95acc9.netlify.app")
            }

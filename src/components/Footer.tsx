  ...
  return (
    <footer className='bg-jet-black relative overflow-hidden'>
      ...
      <div className='absolute inset-0 opacity-5'>
        <div className='absolute top-10 left-10 text-6xl font-bold text-graphite'>
          USDC
        </div>
        <div className='absolute top-32 right-20 text-4xl font-bold text-graphite'>
          USDT
        </div>
        <div className='absolute bottom-32 left-32 text-5xl font-bold text-graphite'>
          DAI
        </div>
        <div className='absolute bottom-16 right-16 text-3xl font-bold text-graphite'>
          BUSD
        </div>
      </div>
      ...
      <div className='relative'>
        ...
        <div className='bg-graphite/20 backdrop-blur-sm border-t border-graphite/30'>
          <div className='container mx-auto px-6 py-16'>
              ...
              <div className='lg:col-span-2'>
                <div className='mb-6'>
                  ...
                  <p className='text-text-muted max-w-sm'>
                    The future of digital payments. Bankless, borderless, and
                    always on.
                  </p>
                </div>
            ...
            {/* Bottom Section */}
            <div className='border-t border-graphite/30 pt-8 flex justify-center items-center'>
